...
const checks = [
  ...
  ["runtime capture failures fall back without ending reading", beginReadingBlock.includes("const handleCaptureFailure") && beginReadingBlock.includes("recorder.onerror = handleCaptureFailure") && beginReadingBlock.includes("track.onended = handleCaptureFailure") && beginReadingBlock.includes("readingGenerationRef.current !== readingGeneration") && beginReadingBlock.includes('setMicStatus("unavailable")')],
  ["capture teardown clears runtime listeners", lesson.includes("track.onended = null") && lesson.includes("expectedRecorder.onerror = null")],
