...
if (text.includes(importReplacement) && text.includes(statusReplacement) && text.includes(completionReplacement)) {
  console.log("OK: lesson completion availability patch already applied.");
  process.exit(0);
}
