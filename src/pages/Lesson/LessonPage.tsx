...
export function LessonPage({
  ...
  async function beginReading() {
    ...
    try {
      ...
      if (readingGenerationRef.current === readingGeneration) setMicStatus("unavailable");
    }
  }
