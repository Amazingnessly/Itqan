...
import { sessionComposition, sessionCompositionLabel } from "./sessionComposition";
...
export function LessonPage({
  ...
  const composition = sessionComposition(
    resolved.map(({ interaction }) => ({ itemId: interaction.itemId })),
  );
