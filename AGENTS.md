...
- Canonical page 57 Tadrib 2 contains a source pool reserved for the later `article_al` shamsiyyah phase. It stays locked until Shaddah mastery and human verification. Do not use it to fill the earlier qamariyyah phase.
- The current canonical progressive PDF does not yet establish a sufficiently broad isolated-word qamariyyah pool for the pre-Shaddah article phase. Do not invent one or split qamariyyah words out of phrases; use separately verified source material when available.
